...
type LabMissionId = "ai-automation-lab" | "security-lab";
type LabContent = Translations["missions"]["items"][LabMissionId];

type LabMissionCardProps = {
  title: string;
  content: LabContent;
  statusLabel: string;
  cvLine?: "top" | "bottom";
...
export function LabMissionCard({
  ...
  if (!flip?.contributedTitle || !flip.contributedItems) {
    return null;
  }
